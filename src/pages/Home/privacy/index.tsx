...
const PrivacyPolicy: React.FC = () => {
  ...
  const ExternalLink: React.FC<Link> = ({
    href,
    text,
    target = "_blank",
  ...
  // Componente para lista de definições
  const DefinitionList: React.FC<{ items: ListItem[] }> = ({ items }) => (
    <ul className="list-disc pl-6 mb-4">
      {items.map((item, index) => (
        <li key={index} className="mb-2">
          {item.term && <strong>{item.term}</strong>} {item.definition}
        </li>
      ))}
    </ul>
  );
  ...
  const Section: React.FC<Section> = ({ title, content, level = "h2" }) => {
    const Heading = level as keyof JSX.IntrinsicElements;
    return (
      <>
        <Heading
          className={`text-${level === "h2" ? "2xl" : level === "h3" ? "xl" : "lg"} font-semibold ${level === "h2" ? "mt-6" : ""} mb-4`}
        >
          {title}
        </Heading>
        {Array.isArray(content) ? content : <p className="mb-4">{content}</p>}
      </>
    );
  };
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 font-sans text-gray-800">
            ...
            <DefinitionList
              items={[
                ...
                },
                {
                  term: "Application",
                  definition:
                    "refers to Ateko, the software program provided by the Company.",
                },
                {
                  term: "Company",
                  definition:
                    '(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Kings Software, Av.Helio Rodrigues Lote 02.',
                },
                {
                  term: "Cookies",
                  definition:
                ...
                { term: "Country", definition: "refers to: Brazil" },
                {
                  term: "Device",
                  definition:
                ...
                },
                {
                  ...
                  definition: (
                    <span>
                      refers to Ateko, accessible from{" "}
                      <ExternalLink
                        href="https://atekoconfig.kingssoftware.com.br/"
                        text="https://atekoconfig.kingssoftware.com.br/"
      ...
      <Section title="Types of Data Collected" level="h3" />
      <Section
        title="Personal Data"
        level="h4"
        content={
      ...
      <Section
        ...
        content={
          <>
            ...
            <DefinitionList
              items={[
                { definition: "Information regarding your location" },
                {
                  definition:
        ...
        content={
          <>
            ...
            <DefinitionList
              items={[
                {
                  term: "Cookies or Browser Cookies.",
                  definition:
      ...
      <Section title="Disclosure of Your Personal Data" level="h3" />
      <Section
      ...
      <Section
        ...
        content={
          <>
            ...
            <DefinitionList
              items={[
                { definition: "Comply with a legal obligation" },
                {
                  definition:
                ...
                { definition: "Protect against legal liability" },
              ]}
            />
          </>
        }
              ...
              items={[
                {
                  definition: (
                    <span>
                      By email:{" "}
                      <ExternalLink
                        href="mailto:ateko@kingssoftware.com.br"
                        text="ateko@kingssoftware.com.br"
                        target="_self"
                        rel=""
                      />
                    </span>
